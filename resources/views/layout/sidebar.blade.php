...
{{--    @endphp--}}
    ...
    <hr class="sidebar-divider my-0">
        <li class="nav-item menu_active_item">
            <a class="nav-link"
               href="#">
...
{{--                    <h6 class="collapse-header">Basic Settings</h6>--}}
{{--                    <a class="collapse-item nav-link set_class" href="{{url('admin/update-password')}}">Change password</a>--}}
